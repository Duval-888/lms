...
const {allCourses} = useContext(AppContext)
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
        ...
        <p>Discover our top-rated courses across various categories. From coding and design 
          to <br/> bussiness and wellness, our courses are crafted to deliver results.</p>
