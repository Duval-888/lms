...
import { assets, dummyTestimonials } from '../../assets/assets'
  ...
  return (
    <div className='pb-14 px-8 md:px-0'>
        ...
        <p className='md:text-base text-gray-500 mt-3'>Hear from our learners as they share their journeys of transformation,
          succes, and how our <br/> platform has made a difference in their lives.
        </p>
        <div className='grid grid-cols-3 gap-8 mt-14'>
          {dummyTestimonials.map((testimonial, index)=>(
            <div key={index}>
              <div className='flex items-flex gap-4 px-5 py-4 bg-gray-500/30
