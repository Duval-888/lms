      ...
      <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
        ...
        md:gap-32 py-10 border-b border-white/30'>
          <div className='flex flex-col md:items-start items-center w-full'>
            ...
            <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem Ipsum is simply dummy text of the printing ans typesetting industry.
            Lorem Ipsum has been the industry's standard dummy text
          </p>
        </div>
        <div className='fle flex-col md:items-start items-center w-full'>
        ...
        <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2026 @ FOBA. All Right Reserved.</p>
      </footer>
    </div>
  )
}
