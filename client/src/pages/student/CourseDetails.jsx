...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, calculateChapterTime, 
    calculateCourseDuration, calculateNoOfLectures, currency} = useContext(AppContext)
 ...
 const toggleSection = (index)=> {
  ...
  return courseData? (
    ...
    left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70'>
      </div>
      ...
      {/*reviewand ratings*/}
          ...
          <div className='flex'>
            ...
            src={i < Math.floor(calculateRating(courseData)) ? assets.star : assets.star_blank} alt=''
            className='w-3.5 h-3.5'/>))}
          </div>
          <p className='text-gray-600'>({courseData.courseRatings.length} 
        ...
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>FOBA</span></p>
...
<div className='pt-5'>
  {courseData.courseContent.map((chapter, index)=> (
    <div key={index} className='borderborder-gray-300 bg-white mb-2 rounded'>
...
onClick={()=> toggleSection(index)}>
        ...
        <p className='text-sm md:text-default'>{chapter.chapterContent.length} 
          lectures - {calculateChapterTime(chapter)}</p>
      </div>
...
<div className='py-20 text-sm md:text-default'>
  ...
  dangerouslySetInnerHTML={{__html: courseData.courseDescription}}></p>
...

      {
        ...
        <img src={
          courseData.courseThumbnail} alt="" />
          <div className='p-5'>
            <div className='flex items-center gap-2'>


          <img className='w-3.5' src={assets.time_left_clock_icon} alt="time left clock icon" />
              <p className='text-red-500'><span font-medium>5days</span> left at this price </p>
            </div>
            ...
            <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>
              ...
              <div className='pt-6'>
                ...
                <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                  ...
                  <li>Downloadableresources and source code.</li>
